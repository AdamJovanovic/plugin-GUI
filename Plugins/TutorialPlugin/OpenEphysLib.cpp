...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "Tutorial"; //Processor name shown in the GUI
		...
		//Class factory pointer. Replace "myProcessorSpace::myProcessor" with the namespace and class name.
		info->processor.creator = &(Plugin::createProcessor<myProcessorSpace::myProcessor>);
		break;
		/**
